...
async function main() {
  ...
  const FlatPremiumV2 = await ethers.getContractFactory("FlatPremiumV2", creator); //V2
  const ParametersV2 = await ethers.getContractFactory("ParametersV2", creator); //V2
